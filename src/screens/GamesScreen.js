...
// const API_KEY = '6f422a0f61d14b269a696173d272d55d'; 
...
//           `https://api.rawg.io/api/games?key=${API_KEY}&search=${encodeURIComponent(text)}&language=rus`
//         );
...
//               {t === 'search' ? 'Поиск' : `Мои (${myGames.length})`}
//             </Text>
//           </TouchableOpacity>
//         ))}
//       </View>
...
//                   onToggle={() => toggleItem(item, 'games')}
//                 />
//               )}
//             />
//           )}
...
export default function GamesScreen() {
  return (
    <View style={styles.container}>
      <Text>Экран игр (в разработке)</Text>
    </View>
  );
}
